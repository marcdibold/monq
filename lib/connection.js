...
function Connection(uri, options) {
    ...
    mongoose.connection.on('error', terminate);
    mongoose.connection.on('disconnecting', terminate);
    mongoose.connection.on('disconnected', terminate);
    mongoose.connection.on('close', terminate);
}
