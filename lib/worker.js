...
Worker.prototype.start = function () {
    if(this.terminated) {
        throw new Error('Worker was terminated, cause of fallen db connection');
    }
...
Worker.prototype.terminate = function (error) {
...
Worker.prototype.resume = function (error) {
    this.terminated = false;
    this.start();

    this.emit('resumed', error);
};
